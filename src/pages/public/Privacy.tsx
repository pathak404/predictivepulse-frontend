...
const Privacy = () => {
  return (
    <Layout>
      <div className="w-full mx-auto py-10 px-5 md:px-16 min-h-[75vh]">
        <h1 className="text-4xl font-semibold mt-4 mb-2 text-center">Privacy Policy</h1>
        <p className="font-mono text-center">Last Updated: 26 Oct 2023</p>

        <div className="mt-8 prose lg:prose-xl mx-auto">
        <p>1. <b>Introduction</b></p>
            <p>Welcome to <b> PredictivePulse</b>.</p>
            <p>
              <b>PredictivePulse</b> (“us”, “we”, or “our”) operates {" "}
              <b>https://predictivepulse.in/</b> (hereinafter referred to as
              <b>“Service”</b>).
            </p>
            <p>
              Our Privacy Policy governs your visit to {" "}
              <b>https://predictivepulse.in/</b>, and explains how we collect,
            ...
            <p>
              <b>SERVICE</b> means the https://predictivepulse.in/ website
              operated by PredictivePulse.
            </p>
            <p>
            ...
            <p>
              ...
              these communications from us by following the unsubscribe link provided in the mail.
            </p>
            <p><b>Usage Data</b></p>
            <p>
            ...
            <p>
              ...
              agreements, NDA agreements, information on bonuses and compensation, information on marital
            ...
            <p>
              PredictivePulse uses the collected data for various purposes:
            </p>
            ...
            <p>
              PredictivePulse will take all the steps reasonably necessary to
            ...
            <p>
              10.
              <b>Your Data Protection Rights Under General Data Protection
                Regulation (GDPR)
              </b>
            </p>
            <p>
            ...
            <p>
              ...
              <b>support@predictivepulse.in</b>.
            </p>
            <p>
            ...
            <p>
              11.
              <b>Your Data Protection Rights under the California Privacy
                Protection Act (CalOPPA)</b>
            </p>
            <p>
            ...
            <p>
              ...
              us at <b>support@predictivepulse.in</b>.
            </p>
            ...
            <p>
              12.
              <b>Your Data Protection Rights under the California Consumer Privacy
                Act (CCPA)</b>
            </p>
            <p>
            ...
            <p>
              <b>0.1. What personal information we have about you. If you make
                this request, we will return to you:</b>
            </p>
            <p>
            ...
            <p>
              <b>0.2. To delete your personal information. If you make this
            ...
            <p>
              <b>0.3. To stop selling your personal information. We don&apos;t sell or
